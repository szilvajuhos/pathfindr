...
<!-- Reference data files TODO: serialize with fst http://www.fstpackage.org/ -->
```{r load_reference}
snptable         = fread('reference_data/private/swegen_snp_counts.csv',key='name')
swegen_manta_all = fread('reference_data/private/swegen_sv_counts.csv',key='name')
#allgenes        = fread('reference_data/genes_ensemble_canonical.csv',key='name')
tumorgenes       = fread('reference_data/cancer_gene_census.csv',key='Gene Symbol')
...
if (project=='BTB') {
  local_tumorgenes=fread('reference_data/2018_gene_list_tere_ref.csv',key='Gene')[Gene!='',1:2]
...
hotspots_inframe=unique(fread('reference_data/hotspots_v2_inframe.csv')[,.(Hugo_Symbol,Amino_Acid_Position)])
...
hotspots_snv=unique(
  fread('reference_data/hotspots_v2_snv.csv')[,.(Hugo_Symbol,Amino_Acid_Position)])[-grep('splice',Amino_Acid_Position)]
...
cosmic_coding    = fread('reference_data/cosmic_coding_table.csv',key = 'name')
cosmic_noncoding = fread('reference_data/cosmic_noncoding_table.csv',key = 'name')
cosmic_fusions   = fread('reference_data/cosmic_fusions_table.csv',key = 'name')
```
